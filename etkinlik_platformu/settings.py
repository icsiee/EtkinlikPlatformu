"""
Django settings for etkinlik_platformu project.
...
SECRET_KEY = 'django-insecure-r#%^ilsu72+*eh)ie)&d@5c(c6gxty=%tip7(77_cojfaan-#+'
...
ROOT_URLCONF = 'etkinlik_platformu.urls'
